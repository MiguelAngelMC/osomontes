<nav class="navbar navbar-expand-lg navbar-dark sticky-top" style="background-color: rgba(0, 0, 0, 1);">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" title="Carrito" ><img src="vistas/img/menu/carrito.png" alt="Logo Carrito de Compras" width="32px"><b> Carrito</b></a>
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
