  ...
  <div class="px-4 py-3">
    ...
    <form method="POST" accept="UTF-8" class="needs-validation" novalidate>
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" id="nvoNombre" name="nvoNombre" value="<?php echo $_GET['marca']; ?>" required="" minlength="3" maxlength="30" pattern="^[a-zA-ZÀ-ÿ\u00f1\u00d1]+(\s*[a-zA-ZÀ-ÿ\u00f1\u00d1]*)*[a-zA-ZÀ-ÿ\u00f1\u00d1]+">
      ...
      ¿Ya modificaste la marca?&nbsp; <a href="index.php?opcion=ver_marcas">Ver Marcas</a>
      </div>
    </form>
  </div>
</div>
