    ...
    <form method="POST" enctype="multipart/form-data" accept="UTF-8" class="needs-validation" novalidate>
      ...
      <script type="text/javascript">
        ...
        function seleccion(){
          ...
          div2 = document.getElementById('group__almacenamiento');
          ...
          if((val == "Teléfono Celular") || (val == "Teléfono de Casa")){
            ...
            almacenamiento.required = true;
          }
          else{
            div.setAttribute("style", "display: none;");
            imei.required = false;
            div2.setAttribute("style", "display: none;");
            almacenamiento.required = false;
          }
        }
      </script>
      ...
      <div class="form-group">
        ...
        <input type="text" style="border-radius: 17px;" class="form-control" id="nombre" name="nombre" placeholder="iPhone 11 Pro" required="" minlength="3" maxlength="30" value="<?php if(isset($_POST['nombre'])){
            echo $_POST['nombre'];
          } ?>">
        <div class="invalid-feedback">
      ...
      <div class="form-group" style="display: none" id="group__almacenamiento">
        <label for="almacenamiento"><b>Almacenamiento:</b></label>
        <input type="text" style="border-radius: 17px;" class="form-control" id="almacenamiento" name="almacenamiento" placeholder="64GB" minlength="1">
        <div class="invalid-feedback">
        Porfavor ingrese la capacidad de almacenamiento del teléfono.
        </div>
      </div>

      <div class="form-group">
        <label for="descripcion"><b>Descripción:</b></label>
        <textarea type="text" style="border-radius: 5px;" class="form-control" id="descripcion" name="descripcion" placeholder="32 GB, 2 GB de RAM Pantalla de 6.2 pulgadas HD + Infinity-V Cámara trasera dual de 13 MP + 2 MP + cámara frontal de 8 MP" required="" pattern="^[a-zA-ZÀ-ÿ\u00f1\u00d1]+(\s*[a-zA-ZÀ-ÿ\u00f1\u00d1]*)*[a-zA-ZÀ-ÿ\u00f1\u00d1]+" minlength="10" maxlength="1000" rows="6"><?php if(isset($_POST['descripcion'])){
      ...
      <div class="form-group">
        ...
        <input type="number" style="border-radius: 17px;" placeholder="$" name="precio_compra" id="precio_compra" class="form-control" required="" min="1" max="1000000" step="0.01" value="<?php if(isset($_POST['precio_compra'])){
            echo $_POST['precio_compra'];
          } ?>">
        <div class="invalid-feedback">
      ...
      <div class="form-group">
        ...
        <input type="number" style="border-radius: 17px;" placeholder="$" name="precio_venta" id="precio_venta" class="form-control" required="" min="1" max="1000000" step="0.01" value="<?php if(isset($_POST['precio_venta'])){
            echo $_POST['precio_venta'];
          } ?>">
        <div class="invalid-feedback">
        Porfavor ingrese el precio del producto.
        </div>
      ...
      <b>¿Ya registraste un producto?</b> <a href="index.php?opcion=ver_productos">Ver Productos</a>
      </div>
    </form>
  </div>
</div>
